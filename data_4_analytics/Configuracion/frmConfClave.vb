        ...
        Try
            If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED _
                ...
                If pVal.BeforeAction = False And pVal.ItemUID = "btnIngre" Then
                    ...
                    SALIDA_POR_PROXY = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "PROXY", "PROXY")
                    ...
                    If SALIDA_POR_PROXY = "Y" Then
                        Proxy_puerto = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "PROXY", "PROXY_PUERTO")
                        Proxy_IP = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "PROXY", "PROXY_IP")
                        Proxy_Usuario = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "PROXY", "PROXY_USER")
                        Proxy_Clave = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "PROXY", "PROXY_CLAVE")
                    ...
                    End If
                    ' END  MANEJO PROXY
                    Dim TimeOutEmision As String = Funciones_SAP.VariablesGlobales._gTimeOut_Emision
                    ...
                    Dim URLWS As String = ofrmParametrosAddon.ConsultaParametro("eDoc", "PARAMETROS", "CONFIGURACION", "WS_Licencia")
                    ...
                    Try
                        If Not Funciones_SAP.VariablesGlobales._gNO_ConsumirMetodoHTTPS = "Y" Then
