...
Public Class FuncionesAddon
    ...
    Public Function ActualizaSecuencia(ByVal code As String, sLineId As String, ByVal UltimaSecuencia As Integer, ByVal DocEntry As String, ByVal Tipotabla As String, ByVal Transaccion As String, ByVal TipoLog As String) As Boolean
        Try
            Dim RetVal As Long
            Dim ErrCode As Long
            ...
            If oUserObjectMD.GetByKey("SS_SER") Then
                GuardaLOG(Tipotabla, DocEntry, "'SS_SER' es un UDO: ", Transaccion, TipoLog)
                oGeneralService = sCmp.GetGeneralService("SS_SER")

                oGeneralParams = oGeneralService.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams)
                oGeneralParams.SetProperty("Code", code)
                GuardaLOG(Tipotabla, DocEntry, "Obteniendo Registro a actualizar en 'SS_SER' por el Code: " + code.ToString(), Transaccion, TipoLog)

                oGeneralData = oGeneralService.GetByParams(oGeneralParams)

                oChildren = oGeneralData.Child("GS_SERD")
                oChild = oChildren.Item(Integer.Parse(sLineId) - 1)

                Try
                    GuardaLOG(Tipotabla, DocEntry, "Validando SI 'Ultima Secuencia' Actual:" + oGeneralData.GetProperty("U_Sec").ToString() + " MAYOR QUE 'Ultima Secuencia' Nueva: " + UltimaSecuencia.ToString(), Transaccion, TipoLog)
                    If Integer.Parse(oGeneralData.GetProperty("U_Sec").ToString()) > UltimaSecuencia Then
                ...
                If ActualizaSecuenc Then
                    '   oGeneralData.SetProperty("U_Sec", UltimaSecuencia.ToString())
                    oChild.SetProperty("U_Sec", UltimaSecuencia.ToString())

                    GuardaLOG(Tipotabla, DocEntry, "Actualizando en 'SS_SER' en el campo 'U_Sec' a : " + UltimaSecuencia.ToString(), Transaccion, TipoLog)
    ...
    Public Sub GuardaLOG(ByVal TipoTabla As String, ByVal DocEntry_Clave As String, ByVal DescripcionLOG As String, ByVal Transaccion As String, ByVal TipoLog As String)
        ...
        If Funciones_SAP.VariablesGlobales._gGuardaLogEmision = "Y" Then
