...
#End Region
    ...
    Public Sub validarVersion_SoloCrearTabla()
        ...
        Try
            '1. Si LA TABLA no existe la creo
            If Not checkCampoBD("@SS_SETUP", "SS_VERS") Then
                creaTablaMD("SS_SETUP", "Setup de AddOn's de GuruSoft", BoUTBTableType.bott_NoObject)
                creaCampoMD("SS_SETUP", "SS_ADDN", "Nombre del AddOn", BoFieldTypes.db_Alpha, , 100)
                creaCampoMD("SS_SETUP", "SS_VERS", "Version del AddOn", BoFieldTypes.db_Alpha, , 100)
                creaCampoMD("SS_SETUP", "SS_LICEN", "Licencia", BoFieldTypes.db_Memo, , 1000)
            End If
    ...
    Public Sub confirmarVersion(ByVal addOnName As String, ByVal addOnVersion As String)
        ...
        Try
            ...
            If lErrCode <> 0 Then
                fPappl.StatusBar.SetText(addOnName + " Error al ingresar configuracion previa: " + sErrMsg, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Else
                fPappl.StatusBar.SetText(addOnName + "  Configuracion previa Ingresada", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
            End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function creaUDO(ByVal Code As String, ByVal Name As String, ByVal TableName As String, Optional ByVal FindColumn As String() = Nothing, Optional ByVal Cancel As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, Optional ByVal Close As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, _
...
Optional ByVal Deleted As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, Optional ByVal DefaultForm As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, Optional ByVal Find As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, Optional ByVal Log As SAPbobsCOM.BoYesNoEnum = SAPbobsCOM.BoYesNoEnum.tNO, _
Optional ByVal objectType As SAPbobsCOM.BoUDOObjType = SAPbobsCOM.BoUDOObjType.boud_MasterData) As Boolean
    ...
    Public Function getCampo(ByVal tabla As String, ByVal nombreCampo As String) As SAPbobsCOM.UserFieldsMD
        Try
            ...
            If fCompany.DbServerType = "9" Then                
                ufRs.DoQuery("select ""FieldID"" from """ & fCompany.CompanyDB & """.CUFD where ""TableID"" = '" & tabla & "' and ""AliasID"" = '" & nombreCampo & "'")
            Else
            ...
            Return Nothing
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getCampo , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return Nothing
        End Try
    End Function
    ...
    Public Function getIdQuery(ByVal nombreQuery As String, ByVal idCat As Integer) As Integer
        Try
            ...
            If fCompany.DbServerType = "9" Then               
                oLocalQ.DoQuery("SELECT ""IntrnalKey"" as Id FROM """ & fCompany.CompanyDB & """.""OUQR"" WHERE ""QName"" = '" & nombreQuery & "'  AND ""QCategory"" = " & idCat)
            Else
            ...
            Return queryId
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdQuery , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return -1
        End Try
    End Function
    ...
    Public Function getIdQuery(ByVal nombreQuery As String, ByVal idCat As Integer, ByVal mCompany As SAPbobsCOM.Company) As Integer
        Try
            ...
            Return queryId
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdQuery2 , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return -1
        End Try
    End Function
    ...
    Public Function getIdQueryCat(ByVal nombreCat As String) As Integer
        Try
            ...
            If fCompany.DbServerType = "9" Then                
                oLocalQ.DoQuery("SELECT ""CategoryId"" as Id FROM """ & fCompany.CompanyDB & """.""OQCN"" WHERE ""CatName"" = '" & nombreCat & "'")
            Else
            ...
            Return queryId
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdQueryCat , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return -1
        End Try
    End Function
    ''' <summary>
    ...
    Public Function getIdQueryCat(ByVal nombreCat As String, ByVal mCompany As SAPbobsCOM.Company) As Integer
        Try
            ...
            Return queryId
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdQueryCat2 , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return -1
        End Try
    End Function
    ...
    Public Function getIdBusquedaF(ByVal FormID_o_TYPE As String, ByVal ItemID As String, Optional ByVal ColID As String = "-1") As Integer
        Try
            ...
            Dim strSQLBF As String
            If fCompany.DbServerType = "9" Then                
                strSQLBF = "SELECT ""IndexID"" FROM """ & fCompany.CompanyDB & """.""CSHS"" WHERE ""FormID""='" & FormID_o_TYPE & "' and ""ItemID""='" & ItemID & "' and ""ColID""='" & ColID & "'"
            Else
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdBusquedaF , Error: " & ex.Message.ToString(), "FuncionesB1")
            Return -1
        End Try
    End Function
    ...
    Public Function getIdBanco(ByVal BankCode As String) As Integer
        ...
        Try
            Dim strSQL As String
            If fCompany.DbServerType = "9" Then                
                strSQL = "SELECT ""AbsEntry"" FROM """ & fCompany.CompanyDB & """.""ODSC"" WHERE ""BankCode""='" & BankCode & "'"
            Else
                strSQL = "SELECT ""AbsEntry"" FROM ODSC WHERE ""BankCode""='" & BankCode & "'"
            End If
    ...
    Public Function getIdUserField(ByVal Tabla As String, ByVal Campo As String) As Integer
        ...
        Try
            ...
            If fCompany.DbServerType = "9" Then                
                strSQL = "SELECT ""FieldID"" FROM """ & fCompany.CompanyDB & """.""CUFD"" WHERE ""TableID"" ='" & Tabla & "' AND ""AliasID"" = '" & Campo & "'"
            Else
                strSQL = "SELECT ""FieldId"" FROM ""CUFD"" WHERE ""TableId"" ='" & Tabla & "' AND ""AliasId"" = '" & Campo & "'"
            End If
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("getIdUserField , Error: " & ex.Message.ToString() + " Qry: " + strSQL, "FuncionesB1")
            Return -1
        End Try
        Release(oLocalUF)
    ...
    Public Sub InsertaConfiguracion()
        ...
        Try
            ...
            If Not oUserTable.GetByKey(99) Then
                ...
                'End If
                oUserTable.UserFields.Fields.Item("U_ws_FC").Value = "http://www.gurusoft-lab.com/eDocColombia/WSEDOC/WSEDOC_FACTURAS.svc?wsdl"
                oUserTable.UserFields.Fields.Item("U_ws_ND").Value = "http://www.gurusoft-lab.com/eDocColombia/WSEDOC/WSEDOC_NOTAS_DEBITO.svc?wsdl"
                oUserTable.UserFields.Fields.Item("U_ws_NC").Value = "http://www.gurusoft-lab.com/eDocColombia/WSEDOC/WSEDOC_NOTAS_CREDITO.svc?wsdl"
                oUserTable.UserFields.Fields.Item("U_ws_CE").Value = "http://www.gurusoft-lab.com/eDocColombia/WSEDOC_FILES/WSEDOC_CONSULTA.svc"
                oUserTable.UserFields.Fields.Item("U_ws_RM").Value = ""
                oUserTable.UserFields.Fields.Item("U_ws_CL").Value = "wsedoc2016"
    ...
    Enum TipoEntidadVinculo
        TipoTabla
        TipoUdo
    End Enum

    Public Sub ActualizaCampoVincularEntidades(ByVal NbTabla As String, ByVal NbCampo As String, ByVal NombreEntidad As String, ByVal TipoEntidad As TipoEntidadVinculo)
        ...
        Try
            ...
            If m <> "" Then
                oUserFieldsMD = fCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oUserFields)
                If oUserFieldsMD.GetByKey(NbTabla, CInt(m)) Then

                    If TipoEntidad = TipoEntidadVinculo.TipoTabla Then
                        oUserFieldsMD.LinkedTable = NombreEntidad
                    ElseIf TipoEntidad = TipoEntidadVinculo.TipoUdo Then
                        oUserFieldsMD.LinkedUDO = NombreEntidad
                    End If
