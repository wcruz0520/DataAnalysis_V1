...
End Enum
Public Class SelectFileDialogRPT
    ...
    Public Property PermitirMultiFile As Boolean
    ...
    Private type As DialogTypeRPT

    Sub New(ByVal folder As String, ByVal file As String, ByVal filter As String, ByVal type As DialogTypeRPT)
        ...
        Me.PermitirMultiFile = False

        Me.SelectedFiles = New List(Of String)
    ...
    Private Sub InternalSelectFileDialog()
        ...
        form.Visible = True
        Select Case (Me.type)
            Case DialogTypeRPT.FOLDER
                Me.FolderDialog(form)
            Case DialogTypeRPT.OPEN
                Me.OpenDialog(form)
            Case DialogTypeRPT.SAVE
                Me.SaveDialog(form)
        End Select
    ...
    Private Sub OpenOrSaveDialog(ByVal dialog As OpenFileDialog, ByVal form As System.Windows.Forms.Form)
        dialog.Title = "Seleccione Archivos"
        dialog.Filter = Me.filter
        '"TXT files (*.txt)|*.txt|All files (*.*)|*.*";
        dialog.InitialDirectory = Me.folder
        dialog.FileName = Me.file

        If Me.PermitirMultiFile Then
        ...
        If (dialog.ShowDialog = DialogResult.OK) Then
            ...
            If Me.PermitirMultiFile Then
                If dialog.FileNames.Count > 0 Then
                    Me.SelectedFiles = dialog.FileNames.ToList
                End If
            Else
