...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'cmdInstall
        '
        Me.cmdInstall.Location = New System.Drawing.Point(400, 216)
        ...
        Me.txtDest.Location = New System.Drawing.Point(24, 169)
        ...
        'chkRestart
        '
        Me.chkRestart.Location = New System.Drawing.Point(24, 219)
        ...
        Me.chkDefaultFolder.Location = New System.Drawing.Point(24, 195)
        ...
        'PictureBox1
        '
        Me.PictureBox1.Image = Global.AddOnInstaller.My.Resources.Resources.LogoSS
        Me.PictureBox1.Location = New System.Drawing.Point(213, 38)
        Me.PictureBox1.Name = "PictureBox1"
        Me.PictureBox1.Size = New System.Drawing.Size(417, 109)
...
#Region "Data members"
    Private sAddonName As String = "slnGSEDOC_SAP_EC_PLUS"
...
#Disable Warning BC40000 ' 'Public Shared ReadOnly DynData As RegistryKey' está obsoleto: 'The DynData registry key only works on Win9x, which is no longer supported by the CLR.  On NT-based operating systems, use the PerformanceData registry key instead.'.
                objParent = Registry.DynData
#Enable Warning BC40000 ' 'Public Shared ReadOnly DynData As RegistryKey' está obsoleto: 'The DynData registry key only works on Win9x, which is no longer supported by the CLR.  On NT-based operating systems, use the PerformanceData registry key instead.'.
        ...
        Try
#Disable Warning BC42104 ' La variable 'objParent' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            objSubkey = objParent.OpenSubKey(Key)
#Enable Warning BC42104 ' La variable 'objParent' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
...
#Disable Warning BC42104 ' La variable 'sAns' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            If ErrInfo = "" And sAns = "" Then
#Enable Warning BC42104 ' La variable 'sAns' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                ErrInfo = _
    ...
    ByVal Value As Object) As Boolean
        ...
        Dim objSubKey As RegistryKey
#Disable Warning BC42024 ' Variable local sin usar: 'sException'.
        Dim sException As String
#Enable Warning BC42024 ' Variable local sin usar: 'sException'.
...
#Enable Warning BC40000 ' 'Public Shared ReadOnly DynData As RegistryKey' está obsoleto: 'The DynData registry key only works on Win9x, which is no longer supported by the CLR.  On NT-based operating systems, use the PerformanceData registry key instead.'.
            ...
            'Open 
#Disable Warning BC42104 ' La variable 'objParentKey' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            objSubKey = objParentKey.OpenSubKey(SubKeyName, True)
#Enable Warning BC42104 ' La variable 'objParentKey' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Sub ExtractFile(ByVal path As String)
        ...
        tabla_dll.Add("frmConsultasDB.srf")
        tabla_dll.Add("frmConsultasDB_RE.srf")

        tabla_dll.Add("zxing.dll")

        'Localizacion SAED

        tabla_dll.Add("frmAcercaDeLE.srf")
        tabla_dll.Add("frmClave.srf")
        tabla_dll.Add("frmConfClaveLE.srf")
        tabla_dll.Add("frmConfMenuLE.srf")

        tabla_dll.Add("frmParametrosAddonLE.srf")
        tabla_dll.Add("frmGeneradorATS.srf")
        tabla_dll.Add("SRI.jpg")
        tabla_dll.Add("frmGenerarRPT.srf")

        tabla_dll.Add("CrystalDecisions.CrystalReports.Engine.dll")
        tabla_dll.Add("CrystalDecisions.ReportSource.dll")
        tabla_dll.Add("CrystalDecisions.Shared.dll")
        'tabla_dll.Add("CrystalDecisions.Windows.Forms.dll")

        'add 15092022
        tabla_dll.Add("frmAnexoCompras.srf")
        tabla_dll.Add("frmAnexoVentas.srf")

        tabla_dll.Add("frmCargaRPT.srf")
        tabla_dll.Add("frmConsultasDbLE.srf")
        tabla_dll.Add("frmSRI.srf")
        tabla_dll.Add("frmSRIConsulta.srf")

        tabla_dll.Add("frmChequeP.srf")
        tabla_dll.Add("frmChequePD.srf")

        tabla_dll.Add("frmTransEntreCompanias.srf")
        tabla_dll.Add("frmConsultaDetalleTrans.srf")
        tabla_dll.Add("frmConsultaSalidaEntrada.srf")
        tabla_dll.Add("frmConsultaBodega.srf")

        tabla_dll.Add("SS_NotaDebitoProtestoHana.rpt")
        tabla_dll.Add("SS_NotaDebitoProtestoSql.rpt")
        tabla_dll.Add("SS_TransferenciaSEHana.rpt")
        tabla_dll.Add("SS_TransferenciaSESQL.rpt")


        tabla_dll.Add("frmPagosMasivos.srf")
        tabla_dll.Add("frmPagosAprobacion.srf")
        tabla_dll.Add("frmGuiasRemision.srf")
        tabla_dll.Add("Microsoft.Office.Interop.Excel.dll")
